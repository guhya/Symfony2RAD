...
/*
 * This is the validator class for product registration/update page
 * Eventhough it looks similar to ProductVO, it is actually different.
 * 
 * Here we can add images and files field which is required to be able to complete
 * product operation but the field itself is not in the VO.
 *
...
class ProductValidator
{
	...
	public function __construct(ProductVO $productVo, $fileList)
	{
